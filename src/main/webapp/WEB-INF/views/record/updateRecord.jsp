...
<body>
	...
	<div align="center" class="container">
		...
		<br>
		<h1 align="center"><spring:message code="label.record.title.update"/></h1>
		<br>
		<spring:url value="/record/updateRecord/${id}" var="updateAction"></spring:url>
		<form:form modelAttribute="recordUpdateForm" action="${updateAction}"
			method="POST">

			<div class="input-group" style="width: 500px;">
				<div class="input-group-prepend">
				<span style="width: 120px;" class="input-group-text" id="">T<spring:message code="lable.record.name"/></span>
