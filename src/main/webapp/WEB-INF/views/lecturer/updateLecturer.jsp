...
<body>
	<%@include file="/WEB-INF/views/common/navigator.jsp"%>
		...
		<br>
		<h1 align="center"><spring:message code="language.lecturer.update.title"/></h1>
		<br>
		<spring:url value="/lecturer/updateLecturer/${id}" var="update"></spring:url>
		<form:form action="${update}" modelAttribute="lecturerUpdateForm"
			method="post">
		<br> 
		<div align="center">
			...
			<div class="col">
				<div class="form-group" style="width: 500px">
					...
					<span style="width: 75px;" class="btn btn-secondary btn-file"> Browse… <input
						type="file" name="file" id="imgInp"></span>
			...
			<div class="row">
	            <div class="form-group col">
	            	<button type="submit" class="btn btn-success"><i class="far fa-save"></i> <spring:message code="language.lecturer.insert.button7"/></button>
	            	<a href="<spring:url value="/lecturer"/>" class="btn btn-warning"><i class="fas fa-angle-left"></i> <spring:message code="language.lecturer.insert.button8"/></a>
	            </div>
	        </div>
		</div>
		</form:form>
