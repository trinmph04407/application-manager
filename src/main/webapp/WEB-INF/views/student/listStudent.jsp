...
<body>
	...
	<div class="container">
		...
		<div>
			...
			<spring:url value="/student" var="listAction"></spring:url>
			<form:form modelAttribute="studentSearchForm" method="GET"
		...
		<div class="row">
			<div class="col">
				<a href="<spring:url value="/student/createStudent"></spring:url>"
					class="btn btn-success"> <i class="fas fa-plus-square"></i> <spring:message
						code="common.button.create" />
				</a>
			</div>
			<div class="col">
		...
		<table class="table table-bordered table-hover">
			<thead class="thead-light">
				<tr>
					...
					<th width="120px;" scope="col"><spring:message
							code="lable.student.action" /></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="student" items="${listStudent}" varStatus="count">
					<tr>
						...
						<td align="center"> <a
							href="<spring:url value="/student/updateStudent/${student.id}"></spring:url>">
								<font color="green" size="15"><i class="fas fa-edit"></i></font>
						</a> <a
							href="<spring:url value="/student/deleteStudent/${student.id}"></spring:url>"
							style="color: #fff;"
