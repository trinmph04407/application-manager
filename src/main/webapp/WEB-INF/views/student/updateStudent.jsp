...
<body>
	...
	<div style="width: 500px;" align="center" class="container">
		<br>
		<h1 align="center">
			<spring:message code="lable.student.title.update" />
		</h1>
		<br>
		<spring:url value="/student/updateStudent/${id}" var="update"></spring:url>
		<form:form action="${update}" modelAttribute="studentUpdateForm"
			...
			<div align="center">
				...
				<div class="input-group" style="width: 500px;">
					...
					<c:set var="classidHasError">
						<form:errors path="classid" />
					</c:set>
					<form:select path="classid" cssClass="form-control"
						cssErrorClass="form-control is-invalid">
						<form:option value="">--- Please select class ---</form:option>
						<form:options items="${listClass}" itemValue="id" itemLabel="code"
							cssClass="form-control ${not empty classidHasError ? 'is-invalid' : ''}" />
					</form:select>
					<div class="invalid-feedback">${classidHasError}</div>
				</div>
				<br>
				<div class="input-group" style="width: 500px;">
					<div class="input-group-prepend">
