...
<body>
	...
	<div class="container">
		...
		<br>
		<h1 align="center">
			<spring:message code="language.class.title" />
		</h1>
		<br>
		...
		<!-- BEGIN SEARCH FORM -->
		<div>
			<spring:url value="/viewslectuner/classlec" var="listAction"></spring:url>
			<form:form modelAttribute="clasessSearchForm" method="GET"
				...
				<div class="row">
					...
					<div class="form-group col">
						<label for="lecturerid"><spring:message
								code="language.class.title1" />: </label>
					...
					<div class="form-group col">
						<label for="majorid"><spring:message
								code="language.class.title2" />: </label>
				...
				<button type="submit" class="btn btn-primary" id="btnSearch">
					...
					<spring:message code="language.class.button1" />
				</button>
				<button type="reset" class="btn btn-warning" id="btnClear">
					<i class="fas fa-eraser"></i>
					<spring:message code="language.class.button2" />
				</button>
			</form:form>
		</div>
