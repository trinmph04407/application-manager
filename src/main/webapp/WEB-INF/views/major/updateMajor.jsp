...
<body>
	...
	<div  style="width: 500px;"  class="container">
		...
		<spring:url value="/major/updateMajor/${id}" var="update"></spring:url>
		<form:form action="${update}" modelAttribute="majorUpdateForm"
			method="post">
		<br>
		
		<h1 align="center"><spring:message code="lable.major.title.update" /></h1>
		<br> <br> 
