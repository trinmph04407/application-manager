...
<body>
	...
	<div class="container">
		...
		<br>
		<h1 align="center"><spring:message code="lable.major.title" /></h1>
		<br>
		...
		<div>
            <spring:url value="/major" var="listAction"></spring:url>
            <form:form modelAttribute="majorSearchForm" method="GET" action="${listAction}" id="searchForm">
                 ...
                 <div class="row">               
                     <div class="form-group col">
                      ...
                      <div class="form-group col">
                         <label for="lecturerId"><spring:message code="lable.major.lecturer" /></label>
                 ...
                 <button type="submit" class="btn btn-primary" id="btnSearch"><i class="fas fa-search"></i> 
                 <spring:message code="common.button.search" /></button>
                 <button type="reset" class="btn btn-warning" id="btnClear"><i class="fas fa-eraser"></i>
                 <spring:message code="common.button.clear" /></button>
            </form:form>
        </div>
		...
		<div class="row">
			<div class="col">
				<a href="<spring:url value="/major/createMajor"></spring:url>"
		...
		<table class="table table-bordered table-hover">
			<thead class="thead-light">
				<tr>
					...
					<th width="120px;" scope="col"><spring:message code="lable.major.function" /></th>
				</tr>
			</thead>
			<tbody>
				<c:if test="${fn:length(listMajor) > 0}">
					<c:forEach items="${listMajor}" var="major" varStatus="loop">
						<tr>
							...
							<td align="center"><a
								href="<spring:url value="/major/updateMajor/${major.id}"></spring:url>">
									<font color="green" size="15"><i class="fas fa-edit"></i></font>
							</a> <a href='<spring:url value="/major/deleteMajor/${major.id}"></spring:url>'
										onclick="return confirm('<spring:message code="common.confirm" />')">
