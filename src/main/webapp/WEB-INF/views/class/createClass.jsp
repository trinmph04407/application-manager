...
<body>
	...
	<div class="container">
		...
		<br>
		<h1 align="center"><spring:message code="language.class.insert.title"/></h1>
		<br> <br>
		<spring:url value="/class/createClass" var="create"></spring:url>
		<form:form action="${create}" modelAttribute="classCreateForm"
			method="post">
			<div align="center">
				<div class="input-group" style="width: 500px;">
					<div class="input-group-prepend">
						<span style="width: 120px;" class="input-group-text" id=""><spring:message code="language.class.insert.button1"/></span>
					</div>
				...
				<div class="input-group" style="width: 500px;">
					<div class="input-group-prepend">
						<span style="width: 120px;" class="input-group-text" id=""><spring:message code="language.class.insert.button2"/>
							</span>
					</div>
				...
				<div class="input-group" style="width: 500px;">
					<div class="input-group-prepend">
						<span style="width: 120px;" class="input-group-text" id=""><spring:message code="language.class.insert.button3"/></span>
					</div>
				...
				<div class="row">
					<div class="form-group col">
						<button type="submit" class="btn btn-success">
							<i class="far fa-save"></i> <spring:message code="language.class.insert.button4"/>
						</button>
						<a href="<spring:url value="/class"/>" class="btn btn-warning"><i
							class="fas fa-angle-left"></i> <spring:message code="language.class.insert.button5"/></a>
					</div>
				</div>
			</div>
		</form:form>
